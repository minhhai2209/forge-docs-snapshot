...
| [forge-templates-bifrost.prod-east.frontend.public.atl-paas.net](http://forge-templates-bifrost.prod-east.frontend.public.atl-paas.net) | CDN where Forge app templates are hosted. The Forge CLI retrieves these templates when the `forge create` command is run. | **Required.** You will not be able to create new Forge apps if this connection is blocked. |
| [forge-templates.us-west-2.prod.public.atl-paas.net](http://forge-templates.us-west-2.prod.public.atl-paas.net) | *(Deprecated — will be removed after 2026-11-26)* Legacy CDN for Forge app templates. Replaced by [forge-templates-bifrost.prod-east.frontend.public.atl-paas.net](http://forge-templates-bifrost.prod-east.frontend.public.atl-paas.net) from `@forge/cli@12.20.1` onwards. | **Required** for CLI versions before `12.20.1`. Optional if using `12.20.1` or later. |
