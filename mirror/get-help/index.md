...
## Documentation index for AI and automation

If you're building AI agents, crawlers, or automation that consume Forge documentation, use our documentation index to discover all pages: [llms.txt](https://developer.atlassian.com/platform/forge/llms.txt).
