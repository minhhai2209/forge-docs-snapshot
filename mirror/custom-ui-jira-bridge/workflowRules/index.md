...
```
1type OnConfigureResponse = string;
2type OnConfigureFn = () => Promise<OnConfigureResponse> | OnConfigureResponse;
3
4function onConfigure(onConfigureFn: OnConfigureFn): Promise<void>;
5
```
