...
If your app is using the new `@forge/kvs` package, see [Querying the Custom Entity Store](/platform/forge/storage-reference/entities-api-query/) instead.

You can build complex queries against
data stored in the [Custom Entity Store](/platform/forge/storage-reference/entities-api/)
...
Using Forge’s [persistent hosted storage](/platform/forge/storage-reference/#persistent) through `@forge/api` package requires the `storage:app` scope in your manifest file:
...
Before you can store data in the Custom Entity Store, you'll need to declare your [custom entities](/platform/forge/storage-reference/entities-manifest/) and indexes first in your app's manifest file.
...
For information about storing data to the Custom Entity Store, see [Storing data in custom entities](/platform/forge/storage-reference/entities-api) .
...
All complex queries operate on a [custom entity's index](/platform/forge/storage-reference/entities-manifest/#indexes). Complex queries follow the same basic signature:
...
[cursor](/platform/forge/storage-reference/#cursors). Cursors enable your
