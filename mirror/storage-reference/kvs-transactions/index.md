...
[batch operations](/platform/forge/storage-reference/kvs-batch/)
instead.
...
You can also set a *relative* time-to-live (TTL) for all keys in your transaction. See [Time-to-live](/platform/forge/storage-reference/kvs-api/#ttl) for related details.
