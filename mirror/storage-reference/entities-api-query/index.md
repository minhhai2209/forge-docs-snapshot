...
[custom entities](/platform/forge/storage-reference/entities-manifest/) and indexes
...
[Storing data in custom entities](/platform/forge/storage-reference/entities-api) .
...
[cursor](/platform/forge/storage-reference/entities/#cursors). Cursors enable your
...
When building a query, do not persist cursors, as they may not always be stable. See [Cursors](/platform/forge/storage-reference/entities/#cursors) for related information.
