...
for them. See [Querying the Custom Entity Store](/platform/forge/storage-reference/entities-api-query/)
for more details.
...
| Attribute | Attribute names must follow the regex `[_A-Za-z][_0-9A-Za-z]*`. | Attribute names have a maximum length of 30 characters. |
...
| ``` range ``` | Yes | Optimizes your index for the use of query [conditions](/platform/forge/storage-reference/entities-api-query/#basic-methods). This parameter can only have one attribute. |
...
[Example queries](/platform/forge/storage-reference/entities-api-query/#example-queries)
in the [Complex query](/platform/forge/storage-reference/entities-api-query/) page.
