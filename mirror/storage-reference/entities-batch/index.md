...
Execute multiple [kvs.set](/platform/forge/storage-reference/kvs-api/#kvs-set) or
[kvs.entity().set](/platform/forge/storage-reference/entities-api/#entity---set) requests
...
You can also set a *relative* time-to-live (TTL) for all keys in your batched operation. See [Time-to-live](/platform/forge/storage-reference/kvs-api/#ttl) for related details.
...
Execute multiple [kvs.get](/platform/forge/storage-reference/kvs-api/#kvs-get) or
[kvs.entity().get](/platform/forge/storage-reference/entities-api/#entity---get) requests
in one operation. You can execute a mix of both types of request in the same batch operation.
...
Execute multiple [kvs.delete](/platform/forge/storage-reference/kvs-api/#kvs-delete) or
[kvs.entity().delete](/platform/forge/storage-reference/entities-api/#entity---delete) requests
in one operation. You can execute a mix of both types of request in the same batch operation.
