...
![Examples of different image sizes that include xsmall, small, medium, large, xlarge to optimize images for different devices](https://dac-static.atlassian.com/platform/forge/images/ui-kit-2/image-sizes.png?_v=1.5800.2075)
...
![black and white cat sitting on a bamboo chair, smirking as if to say, "This room is my fluffy kingdom"](https://dac-static.atlassian.com/platform/forge/images/ui-kit-2/image-default.png?_v=1.5800.2075)
...
![Example of an animated GIF depicting Homer Simpson retreating into bushes, referencing the popular 'Homer Simpson disappearing' meme](https://dac-static.atlassian.com/platform/forge/images/homer.gif?_v=1.5800.2075)
