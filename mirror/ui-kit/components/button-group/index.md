...
```
1import { ButtonGroup } from '@forge/react';
2
```
...
![Example image of a rendered default ButtonGroup](https://dac-static.atlassian.com/platform/forge/ui-kit/images/button-group/button-group-examples.png?_v=1.5800.2324)
...
![Example image of a rendered primary ButtonGroup](https://dac-static.atlassian.com/platform/forge/ui-kit/images/button-group/button-group-appearance.png?_v=1.5800.2324)
