...
![Example image of rendered link](https://dac-static.atlassian.com/platform/forge/ui-kit/images/link/link-default.png?_v=1.5800.2309)

```
1const LinkExample = () => {
2  return (
3    <Text>
4      <Link href="https://atlassian.com">Log in</Link> to view this content
5    </Text>
6  );
7}
8
