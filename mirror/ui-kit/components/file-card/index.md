...
```
1import { FileCard } from "@forge/react";
2
```
...
![Example image of file card](https://dac-static.atlassian.com/platform/forge/ui-kit/images/file-card/file-card.png?_v=1.5800.2300)
...
![Example image of file card with file size](https://dac-static.atlassian.com/platform/forge/ui-kit/images/file-card/file-card-with-file-size.png?_v=1.5800.2300)
...
![Example image of file card with file types](https://dac-static.atlassian.com/platform/forge/ui-kit/images/file-card/file-card-with-file-types.png?_v=1.5800.2300)
...
![Example image of file card with error](https://dac-static.atlassian.com/platform/forge/ui-kit/images/file-card/file-card-with-error.png?_v=1.5800.2300)
...
![Example image of empty state with custom heading level](https://dac-static.atlassian.com/platform/forge/ui-kit/images/file-card/file-card-with-upload-progress.png?_v=1.5800.2300)
