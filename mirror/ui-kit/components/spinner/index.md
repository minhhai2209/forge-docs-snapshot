...
```
1import { Spinner } from '@forge/react';
2
```
...
![Example image of a spinner](https://dac-static.atlassian.com/platform/forge/ui-kit/images/spinner/spinner-default.png?_v=1.5800.2324)
...
![Example image of a inverted spinner](https://dac-static.atlassian.com/platform/forge/ui-kit/images/spinner/spinner-invert.png?_v=1.5800.2324)
...
![Example image of spinner sizes](https://dac-static.atlassian.com/platform/forge/ui-kit/images/spinner/spinner-sizes.png?_v=1.5800.2324)
