...
```
1import { FilePicker } from "@forge/react";
2
```
...
![Example image of file picker](https://dac-static.atlassian.com/platform/forge/ui-kit/images/file-picker/file-picker.png?_v=1.5800.2286)
...
![Example image of file picker with additional elements](https://dac-static.atlassian.com/platform/forge/ui-kit/images/file-picker/file-picker-with-elements.png?_v=1.5800.2286)
