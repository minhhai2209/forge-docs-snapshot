...
<td><code>(e: KeyboardOrMouseEvent) => void</code></td>
<td>No</td>
<td>Callback function called when the modal dialog is requesting to be closed.</td>
</tr>
<tr>
<td><code>shouldScrollInViewport</code></td>
<td><code>boolean</code></td>
<td>No</td>
<td>Will set the scroll boundary to the viewport. If set to false, the scroll boundary is set to the modal dialog body.</td>
</tr>
<tr>
<td><code>label</code></td>
<td><code>string</code></td>
<td>No</td>
<td>The label of the modal dialog that is announced to users of assistive technology. This should only be used if there is no modal title being associated to your modal.</td>
</tr>
<tr>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code>ForgeElement</code></td>
            <td>Yes</td>
            <td>Children of modal dialog body.</td>
        </tr>
    </tbody>
</table>
<br/>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code>ForgeElement</code></td>
            <td>No</td>
            <td>Children of modal dialog footer.</td>
        </tr>
    </tbody>
</table>
<br/>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code>ForgeElement</code></td>
            <td>No</td>
            <td>Children of modal dialog header.</td>
        </tr>
    </tbody>
</table>
<br/>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code>"warning" | "danger" </code></td>
            <td>No</td>
            <td>Appearance of the modal, which changes the color of the primary action and adds an icon to the title.</td>
        </tr>
        <tr>
            <td><code>isMultiline</code></td>
            <td><code>boolean</code></td>
            <td>No</td>
            <td>When set to <code>true</code>, this will allow the title to span multiple lines. Defaults to <code>true</code>.<td>
        </tr>
        <tr>
            <td><code>children</code></td>
            <td><code>ForgeElement</code></td>
            <td>No</td>
            <td>Children of modal dialog title.</td>
        </tr>
    </tbody>
</table>
<br/>
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><code>ForgeElement</code></td>
            <td>No</td>
            <td>Children can be any Forge Element.</td>
        </tr>
    </tbody>
</table>
<br/>
...
![Example image of a rendered default modal](/platform/forge/ui-kit/images/modal/modal-dialog-default.png)
...
![Example image of a rendered modal warning appearance](/platform/forge/ui-kit/images/modal/modal-dialog-warning.png)
...
![Example image of a rendered modal danger appearance](/platform/forge/ui-kit/images/modal/modal-dialog-danger.png)
...
![Example image of a rendered modal with small width](/platform/forge/ui-kit/images/modal/modal-dialog-width-small.png)
...
![Example image of a rendered modal scrolling behaviour](/platform/forge/ui-kit/images/modal/modal-dialog-scrolling-behaviour.png)
...
![Example image of a rendered modal form](/platform/forge/ui-kit/images/modal/modal-dialog-form.png)
...
![Example image of a rendered modal header](/platform/forge/ui-kit/images/modal/modal-dialog-header.png)
...
![Example image of a rendered modal footer](/platform/forge/ui-kit/images/modal/modal-dialog-modal-footer.png)
