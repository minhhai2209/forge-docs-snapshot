...
```
1import { Tooltip } from '@forge/react';
2
```
...
![Example image of a tooltip](https://dac-static.atlassian.com/platform/forge/ui-kit/images/tooltip/tooltip-default.png?_v=1.5800.2286)
...
![Example image of a tooltip with different positions set](https://dac-static.atlassian.com/platform/forge/ui-kit/images/tooltip/tooltip-position.png?_v=1.5800.2286)
...
![Example image of a tooltip using mouse position](https://dac-static.atlassian.com/platform/forge/ui-kit/images/tooltip/tooltip-mouse-position.png?_v=1.5800.2286)
