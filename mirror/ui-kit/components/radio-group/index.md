...
```
1import { RadioGroup } from '@forge/react';
2
```
...
![Example image of a radio group](https://dac-static.atlassian.com/platform/forge/ui-kit/images/radio-group/radio-group-default.png?_v=1.5800.2330)
...
![Example image of a disabled radio group](https://dac-static.atlassian.com/platform/forge/ui-kit/images/radio-group/radio-group-disabled.png?_v=1.5800.2330)
...
![Example image of a required radio group in a Form](https://dac-static.atlassian.com/platform/forge/ui-kit/images/radio-group/radio-group-required.png?_v=1.5800.2330)
