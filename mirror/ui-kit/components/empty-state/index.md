...
![Example image of empty state](https://dac-static.atlassian.com/platform/forge/ui-kit/images/empty-state/empty-state-default.png?_v=1.5800.2106)
...
![Example image of empty state with custom heading level](https://dac-static.atlassian.com/platform/forge/ui-kit/images/empty-state/empty-state-custom-heading-level.png?_v=1.5800.2106)
...
![Example image of empty state with description](https://dac-static.atlassian.com/platform/forge/ui-kit/images/empty-state/empty-state-description.png?_v=1.5800.2106)
...
![Example image of empty state one action](https://dac-static.atlassian.com/platform/forge/ui-kit/images/empty-state/empty-state-actions-primary.png?_v=1.5800.2106)
...
![Example image of empty state with two actions](https://dac-static.atlassian.com/platform/forge/ui-kit/images/empty-state/empty-state-actions-secondary.png?_v=1.5800.2106)
...
![Example image of empty state with all actions](https://dac-static.atlassian.com/platform/forge/ui-kit/images/empty-state/empty-state-actions-tertiary.png?_v=1.5800.2106)
...
![Example image of loading state empty state](https://dac-static.atlassian.com/platform/forge/ui-kit/images/empty-state/empty-state-loading-state.png?_v=1.5800.2106)
...
![Example image of narrow empty state](https://dac-static.atlassian.com/platform/forge/ui-kit/images/empty-state/empty-state-width-narrow.png?_v=1.5800.2106)
