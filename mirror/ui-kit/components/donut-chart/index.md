...
```
1import { DonutChart } from '@forge/react';
2
```
...
![Example image of a rendered donut chart](https://dac-static.atlassian.com/platform/forge/ui-kit/images/donut-chart/donut-chart-data.png?_v=1.5800.2324)
