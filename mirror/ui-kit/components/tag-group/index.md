...
```
1import { TagGroup } from '@forge/react';
2
```
...
![Example image of a tag group](https://dac-static.atlassian.com/platform/forge/ui-kit/images/tag-group/tag-group-default.png?_v=1.5800.2296)
...
![Example image of a start aligned tag group](https://dac-static.atlassian.com/platform/forge/ui-kit/images/tag-group/tag-group-alignment-start.png?_v=1.5800.2296)
...
![Example image of an end aligned tag group](https://dac-static.atlassian.com/platform/forge/ui-kit/images/tag-group/tag-group-alignment-end.png?_v=1.5800.2296)
