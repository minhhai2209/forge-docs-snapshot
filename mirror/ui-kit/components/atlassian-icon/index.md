...
![Grid of available Atlassian icon types with labels](https://dac-static.atlassian.com/platform/forge/ui-kit/images/atlassian-icon/atlassian-icon-examples.png?_v=1.5800.2167)
...
![Example image of default AtlassianIcon](https://dac-static.atlassian.com/platform/forge/ui-kit/images/atlassian-icon/atlassian-icon-default.png?_v=1.5800.2167)
...
![Example image of AtlassianIcon sizes](https://dac-static.atlassian.com/platform/forge/ui-kit/images/atlassian-icon/atlassian-icon-size.png?_v=1.5800.2167)
