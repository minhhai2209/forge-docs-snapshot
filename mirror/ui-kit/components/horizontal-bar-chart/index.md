...
```
1import { HorizontalBarChart } from '@forge/react';
2
```
...
![Example image of a rendered grouped horizontal bar chart](https://dac-static.atlassian.com/platform/forge/ui-kit/images/horizontal-bar-chart/grouped-data-horizontal-bar-chart-example.png?_v=1.5800.2309)
