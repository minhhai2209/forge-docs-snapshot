...
```
1import { HorizontalStackBarChart } from '@forge/react';
2
```
...
![Example image of a rendered horizontal stack bar chart](https://dac-static.atlassian.com/platform/forge/ui-kit/images/horizontal-stack-bar-chart/horizontal-stack-bar-chart-data.png?_v=1.5800.2300)
