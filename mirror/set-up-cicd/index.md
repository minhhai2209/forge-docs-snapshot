...
![Enable Pipelines for your repository](https://dac-static.atlassian.com/platform/forge/images/cicd-enable-pipelines.png?_v=1.5800.2102)
...
![Define your Forge login details through repository variables](https://dac-static.atlassian.com/platform/forge/images/cicd-define-login-variables.png?_v=1.5800.2102)
...
![View pipeline progress](https://dac-static.atlassian.com/platform/forge/images/cicd-pipeline-init-run.png?_v=1.5800.2102)

Once the pipeline **Status** is **Successful**, select it to view its details. Notice that the **Deploy to Production**
step didn’t run:

![Manually deploy to production](https://dac-static.atlassian.com/platform/forge/images/cicd-manual-step.png?_v=1.5800.2102)
