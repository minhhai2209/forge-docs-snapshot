# Reference architecture for work item custom field apps in Jira

**[Go to sample code](https://bitbucket.org/atlassian/reference-architectures/src/main/forge-issue-picker-custom-field-type/)**

## Overview

This reference architecture demonstrates how to add a work item custom field to Jira using a Forge app.
