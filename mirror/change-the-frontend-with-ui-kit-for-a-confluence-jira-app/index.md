...
![A Confluence page displaying the hello world forge app with comments counted](https://dac-static.atlassian.com/platform/forge/images/display-xpa-confluence-macro.png?_v=1.5800.2160)

Your Jira issue should look like the following:

![A Jira issue displaying the hello world forge app with comments counted](https://dac-static.atlassian.com/platform/forge/images/display-xpa-jira-issue-panel.png?_v=1.5800.2160)
...
[![A button to go back a page](https://dac-static.atlassian.com/platform/forge/images/button-go-back.svg?_v=1.5800.2160)](/platform/forge/add-support-for-jira-as-an-optional-atlassian-app/)
