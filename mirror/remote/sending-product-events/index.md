...
![Forge Remote diagram describing the flow of events and auth between Forge and remote application, with an event queue setup on the remote app](https://dac-static.atlassian.com/platform/forge/images/remote/remote-events-diagram.png?_v=1.5800.2286)
