...
[Key-Value Store (KVS)](/platform/forge/rest/v1/api-group-key-value-store/) or
[Custom Entity Store](/platform/forge/rest/v1/api-group-custom-entity-store/) via REST API.
