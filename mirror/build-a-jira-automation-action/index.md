...
![Initial Forge CLI commands](https://dac-static.atlassian.com/platform/forge/images/forge-automation-action-tutorial/forge-automation-tutorial-initial-commands.png?_v=1.5800.2249)
...
![Select the Work Item Created trigger](https://dac-static.atlassian.com/platform/forge/images/forge-automation-action-tutorial/forge-automation-tutorial-rule-work-item-created-trigger.png?_v=1.5800.2249)

**Step 7d**: Add the action “Requirement Info Provider”.

![Add the action Requirement Info Provider](https://dac-static.atlassian.com/platform/forge/images/forge-automation-action-tutorial/forge-automation-tutorial-rule-requirement-infor-provider.png?_v=1.5800.2249)
...
![Add the work item key](https://dac-static.atlassian.com/platform/forge/images/forge-automation-action-tutorial/forge-automation-tutorial-rule-issue-key.png?_v=1.5800.2249)
...
![Add the comment to the rule](https://dac-static.atlassian.com/platform/forge/images/forge-automation-action-tutorial/forge-automation-tutorial-rule-add-comment.png?_v=1.5800.2249)
...
![Test the automation rule](https://dac-static.atlassian.com/platform/forge/images/forge-automation-action-tutorial/forge-automation-tutorial-test-rule.png?_v=1.5800.2249)
