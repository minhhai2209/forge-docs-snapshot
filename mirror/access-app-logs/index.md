...
7. In the **Details** tab, under **Logs access**, enable the setting.
   ...
   ![The admin hub app details page, showing details, and the section to enable logs](https://dac-static.atlassian.com/platform/forge/images/admin-hub-access-prod-logs-section.png?_v=1.5800.1963)
