...
4. Find the Forge app that exposes REST APIs and click **View app details**.
   ...
   ![Screenshot](https://dac-static.atlassian.com/platform/forge/images/forge-rest-apis/admin-hub-connected-apps-details.png?_v=1.5800.1901)
5. On the app details page, open the **Details** tab and locate the **App REST APIs** section.
   ...
   ![Screenshot](https://dac-static.atlassian.com/platform/forge/images/forge-rest-apis/admin-hub-connected-apps-rest-api-toggle.png?_v=1.5800.1901)

   ![Screenshot](https://dac-static.atlassian.com/platform/forge/images/forge-rest-apis/admin-hub-connected-apps-enable-rest-apis.png?_v=1.5800.1901)
...
3. Follow the prompts to name and create your 3LO app.
   ...
   ![Screenshot](https://dac-static.atlassian.com/platform/forge/images/forge-rest-apis/dev-console-create-3lo-integration.png?_v=1.5800.1901)

   ![Screenshot](https://dac-static.atlassian.com/platform/forge/images/forge-rest-apis/dev-console-name-3lo-integration.png?_v=1.5800.1901)
...
2. On the right side, click **Add Marketplace or custom app**.
   ...
   ![Screenshot](https://dac-static.atlassian.com/platform/forge/images/forge-rest-apis/dev-console-3lo-add-forge-app-button.png?_v=1.5800.1901)
3. In the modal that opens, first select the **site** where the Forge app is installed.

   ![Screenshot](https://dac-static.atlassian.com/platform/forge/images/forge-rest-apis/dev-console-modal-with-site.png?_v=1.5800.1901)
4. After you select the site, you’ll see a list of Forge apps installed on that site. Choose the
   ...
   ![Screenshot](https://dac-static.atlassian.com/platform/forge/images/forge-rest-apis/dev-console-modal-with-app.png?_v=1.5800.1901)
5. Select the **scopes** that your integration needs, based on the app developer’s documentation. You must select at least one scope.
   ...
   ![Screenshot](https://dac-static.atlassian.com/platform/forge/images/forge-rest-apis/dev-console-forge-app-scopes-modal.png?_v=1.5800.1901)
...
6. Select **Add**. The Forge app will then appear in the **Permissions** tab for your 3LO integration. You
   ...
   ![Screenshot](https://dac-static.atlassian.com/platform/forge/images/forge-rest-apis/dev-console-permissions-tab-with-forge-app.png?_v=1.5800.1901)
...
2. After you configure the callback, the Developer Console will show an **authorization URL** for
   ...
   ![Screenshot](https://dac-static.atlassian.com/platform/forge/images/forge-rest-apis/dev-console-authorization-tab.png?_v=1.5800.1901)

   ![Screenshot](https://dac-static.atlassian.com/platform/forge/images/forge-rest-apis/dev-console-auth-url.png?_v=1.5800.1901)
