...
![Runs on Atlassian page on app listing page](https://dac-static.atlassian.com/platform/forge/images/app-listing.svg?_v=1.5800.1617)
...
permissions:
  external:
    ...
    images:
      - '*.atlassian.com' # non-analytics egress
```
```
