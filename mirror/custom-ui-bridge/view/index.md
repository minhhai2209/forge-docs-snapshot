...
The `onClose` method enables you to register a callback that runs when a module-level modal is closed, such as the [macro custom config](/platform/forge/add-custom-configuration-to-a-macro.md) modal. This is supported in Jira and Confluence modules.
...
![Example rendered Custom UI bodied macro contents](https://dac-static.atlassian.com/platform/forge/apis-reference/ui-api-bridge/images/view/view-createAdfRendererIframeProps-custom-ui-bodied-macro.svg?_v=1.5800.2184)
