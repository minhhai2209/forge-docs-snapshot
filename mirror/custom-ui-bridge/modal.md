...
- **resource**: The key of the static resource to open in the modal dialog. If not provided, the resource
  ...
  to `settings.html`). See [Resources — Multiple entry points](/platform/forge/manifest-reference/resources/#multiple-entry-points).
...
1. the resource file you defined in the manifest file, which is the `my-modal-resource.js` file
