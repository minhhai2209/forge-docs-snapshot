...
![Example of configuring a Forge macro](https://dac-static.atlassian.com/platform/forge/images/macro-config-demo.gif?_v=1.5800.2106)
...
* Consider using the [encryption features of Forge Storage](/platform/forge/storage-reference/kvs-api-secret/) to store sensitive data.
...
2. Select ![Insert icon from the toolbar](https://dac-static.atlassian.com/platform/forge/images/select_dropdown.png?_v=1.5800.2106) from the toolbar.
