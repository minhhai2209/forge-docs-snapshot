...
3. With your Forge app open in ItelliJ click on **Current File** and **Edit Configurations**.
   ...
   ![Image of edit configuration in IntelliJ](https://dac-static.atlassian.com/platform/forge/images/debug-functions-tutorial/edit-configuration.png?_v=1.5800.1739)
...
5. Give the configuration a new name (for example, *Forge Debugger*), and make sure the port matches the port from your CLI command (for example, *9229*).
   ...
   ![Image of configuration pop up panel](https://dac-static.atlassian.com/platform/forge/images/debug-functions-tutorial/config-debug-panel.png?_v=1.5800.1739)
6. Click **OK**.
...
2. Run the debugger by clicking the bug icon in the top right of the screen.
   ...
   ![Image of running bug icon to debug](https://dac-static.atlassian.com/platform/forge/images/debug-functions-tutorial/debug-forge-bug-icon.png?_v=1.5800.1739)
