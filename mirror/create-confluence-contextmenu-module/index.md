...
![Confluence context menu](https://dac-static.atlassian.com/platform/forge/images/context-menu.png?_v=1.5800.1886)
...
4. Open a Confluence page and select some text. When the menu appears, click the dropdown
   ...
   ![App displaying selected text](https://dac-static.atlassian.com/platform/forge/images/context-menu-highlighted-text.png?_v=1.5800.1886)
