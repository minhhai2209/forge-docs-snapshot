...
![Metrics screen](https://dac-static.atlassian.com/platform/forge/snippets/images/usage-metrics-costs-screen.png?_v=1.5800.2075)
...
![Metrics screen](https://dac-static.atlassian.com/platform/forge/images/site_breakdown.png?_v=1.5800.2075)
...
Storage metrics are measured in GB. These usage metrics apply to the use of [Forge hosted storage](https://developer.atlassian.com/platform/forge/storage-reference/) in any environment.
