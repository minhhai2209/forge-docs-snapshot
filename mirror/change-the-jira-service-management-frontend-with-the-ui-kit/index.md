...
4. Refresh the Jira Service Management queues view.
   ...
   ![A Jira Service Management queue page app displaying the hello world with queues counted](https://dac-static.atlassian.com/platform/forge/images/forge-getting-started-jira-service-management-final-state.png?_v=1.5800.2022)
...
[![A button to go back a page](https://dac-static.atlassian.com/platform/forge/images/button-go-back.svg?_v=1.5800.2022)](/platform/forge/call-a-jira-service-management-api/)
