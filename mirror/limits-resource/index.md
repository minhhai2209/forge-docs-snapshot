...
If your app has multiple views or modules, you can define up to 50 named entry points within a single resource using the [entry property](/platform/forge/manifest-reference/resources/#multiple-entry-points-preview), rather than declaring a separate resource for each view. This approach has several benefits:
