...
list webtrigger URLs

## Usage

```
1Usage: forge webtrigger list [options]
2
```
...
3-s, --site [site]                site URL (example.atlassian.net)
4-p, --product [Atlassian app]    Atlassian app (Jira, Confluence, Compass,
5                                 Bitbucket)
