...
```
1Usage: forge register [options] [name]
2
```
...
2--personal                                     register as a personal app
3-s, --developer-space-id <Developer Space id>  specify the Developer Space id to use
4-y, --accept-terms                             automatically accept terms and conditions in non-interactive mode
