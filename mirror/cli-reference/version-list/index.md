...
returns a summary of all major versions of the app. Summary includes:
...
```
1Usage: forge version list [options]
2
```
...
5--json                           output results in JSON format (default:
6                                 false)
7-f, --out-file <outFile>         specify a file to output the results
