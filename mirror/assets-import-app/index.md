...
![Assets Import Type Selection Screen.](https://dac-static.atlassian.com/platform/forge/images/assets-import-type-selection.png?_v=1.5800.1905)
...
1. onDeleteImport - Triggers on a deletion of an import structure
   ...
   ![Deleting an Assets App Type Import Structure.](https://dac-static.atlassian.com/platform/forge/images/assets-delete-import.png?_v=1.5800.1905)
2. startImport - Triggers on the start of an import
   ...
   ![Starting an Assets App Type Import.](https://dac-static.atlassian.com/platform/forge/images/assets-start-import.png?_v=1.5800.1905)
3. stopImport - Triggers on the cancellation of an import
   ...
   ![Stopping an Assets App Type Import.](https://dac-static.atlassian.com/platform/forge/images/assets-stop-import.png?_v=1.5800.1905)
4. importStatus - Triggers to display the status of the import on the Imports UI
   ...
   ![Showing progress on an Assets App Type Import.](https://dac-static.atlassian.com/platform/forge/images/assets-progress-import-not-configured.png?_v=1.5800.1905)

   ![Showing progress on an Assets App Type Import.](https://dac-static.atlassian.com/platform/forge/images/assets-progress-import-ready.png?_v=1.5800.1905)
...
![Forge Template Async Events API example](https://dac-static.atlassian.com/platform/forge/images/assets-import-async-events-api-example.png?_v=1.5800.1905)
