...
![Space settings shows Space news app](https://dac-static.atlassian.com/platform/forge/images/space-news-settings.png?_v=1.5800.2094)

The final `contentBylineItem` module looks like the following:
![Content byline item shows Space news app](https://dac-static.atlassian.com/platform/forge/images/space-news-byline.png?_v=1.5800.2094)
