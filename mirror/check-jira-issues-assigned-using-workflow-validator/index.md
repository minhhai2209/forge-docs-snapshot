...
![Jira board showing a notification message "The issue must have an assignee before transitioning."](https://dac-static.atlassian.com/platform/forge/images/jira-validator-block-transition.png?_v=1.5800.1858)
...
1. Open [Advanced workflow
   ...
   ![The add validator to transition screen showing the Forge app is selected from a list](https://dac-static.atlassian.com/platform/forge/images/jira-add-validator.png?_v=1.5800.1858)
