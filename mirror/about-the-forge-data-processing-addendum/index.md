...
The [Forge Data Processing Addendum (Forge DPA)](https://dac-static.atlassian.com/platform/forge/resources/Forge-Data-Processing-Addendum.pdf?_v=1.5800.2075) is incorporated by reference in the [Forge Terms](/platform/forge/developer-terms/), which all Forge developers must comply with in order to use the Forge platform.
