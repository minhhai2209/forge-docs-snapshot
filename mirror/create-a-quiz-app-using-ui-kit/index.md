...
![A gif is added to a Confluence page](https://dac-static.atlassian.com/platform/forge/images/quiz-app.gif?_v=1.5800.2262)
...
![A diagram of the quiz app is added to a Confluence page](https://dac-static.atlassian.com/platform/forge/images/quiz-app-diagram.png?_v=1.5800.2262)

We are also going to use `Inline` and `Stack` components to layout our components:

![A diagram showing the inline and stack components is added to a Confluence page](https://dac-static.atlassian.com/platform/forge/images/quiz-app-diagram-inline-stack.png?_v=1.5800.2262)
...
![The app is inserted into a Confluence page](https://dac-static.atlassian.com/platform/forge/images/quiz-app-part-1.png?_v=1.5800.2262)
...
![A gif is added to a Confluence page](https://dac-static.atlassian.com/platform/forge/images/quiz-app-before-ending-screen.gif?_v=1.5800.2262)
