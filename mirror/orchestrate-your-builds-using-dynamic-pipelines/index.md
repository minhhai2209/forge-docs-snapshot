...
1. Navigate to the settings for a repository in the installed workspace where you want to test the
   ...
   ![Dynamic Pipelines page in the repository settings](https://dac-static.atlassian.com/platform/forge/images/bitbucket-dynamic-pipelines-tutorial-repo-settings-dynamic-pipelines-page.png?_v=1.5800.1794)
2. From that tab, select the dynamic pipelines provider you just installed from the “Repository
   ...
   ![Dynamic Pipelines provider selector displays the installed app](https://dac-static.atlassian.com/platform/forge/images/bitbucket-dynamic-pipelines-tutorial-repo-settings-dynamic-pipelines-provider-selector.png?_v=1.5800.1794)
...
2. Run a pipeline in the repository you previously configured with your dynamic pipeline by either
   ...
   ![Run pipeline button on the repository pipelines page](https://dac-static.atlassian.com/platform/forge/images/bitbucket-dynamic-pipelines-tutorial-run-pipeline-button.png?_v=1.5800.1794)
...
4. Run the `default` pipeline in a repo in your Bitbucket workspace, and verify the following:
   ...
   * `Updated request` appears in your tunnel and the logged output contains the new step.
   ...
   ![The added step configuration appears in the tunnel log](https://dac-static.atlassian.com/platform/forge/images/bitbucket-dynamic-pipelines-tutorial-tunnel-log.png?_v=1.5800.1794)
   ...
   * The triggered pipeline has an extra step which was generated by the app, and that step
   ...
   ![The pipeline includes the dynamically added step](https://dac-static.atlassian.com/platform/forge/images/bitbucket-dynamic-pipelines-tutorial-pipeline-with-dynamic-step.png?_v=1.5800.1794)

   * The link to the dynamic configuration appears in the sidebar.

   ![The link to the dynamic configuration is shown in the sidebar](https://dac-static.atlassian.com/platform/forge/images/bitbucket-dynamic-pipelines-tutorial-dynamic-pipeline-configuration-link.png?_v=1.5800.1794)
   ...
   * And you can open the dynamically generated configuration and view it from the UI.
   ...
   ![The modal dialog with the dynamic pipeline configuration](https://dac-static.atlassian.com/platform/forge/images/bitbucket-dynamic-pipelines-tutorial-dynamic-pipeline-configuration-modal-dialog.png?_v=1.5800.1794)
...
9. Run the `default` pipeline in a repo in your Bitbucket workspace, and verify that the triggered
   ...
   ![The added step includes the number of updated files in the commit](https://dac-static.atlassian.com/platform/forge/images/bitbucket-dynamic-pipelines-tutorial-pipeline-with-commit-stats-step.png?_v=1.5800.1794)
