...
| id | string | Uniquely identifies the event. |
| source | string | Identifies the context within which an event occurred. |
| type | string | Describes the type of event related to the originating occurrence. The event type is suffixed by the event type version. **Examples:** `avi:ecosystem.app_policy:blocked:app_access_to_objects_in_container.v2[object Object]` |
| time | string | Timestamp of when the occurrence happened. Must adhere to RFC 3339. |
| data | object |  |
