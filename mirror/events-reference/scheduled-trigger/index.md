...
However, the request object for scheduled trigger function contains fewer properties than for a web trigger function.
...
[Learn more about scheduled triggers and how to configure them in the manifest](/platform/forge/manifest-reference/modules/scheduled-trigger).
...
| --- | --- | --- | --- |
| `context` | `string` | Yes | Properties identifying this scheduled trigger to Atlassian |
| `context.cloudId` | `object` | Yes | The cloud ID. |
...
| `installContext` | `string` | Yes | Identifier for the site and Atlassian app instance in which the app is running. |
