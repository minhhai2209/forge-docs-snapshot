...
The `bitbucket:workspaceGlobalPage` module adds an item to the `Apps` section in the left navigation of Bitbucket
workspace pages. The menu item will be visible in the navigation bar for workspace members when viewing pages within a
workspace context. When you select the menu item, the content will render in a new page. You can use the [UI
Kit](/platform/forge/ui-kit/) or [Custom UI](/platform/forge/custom-ui/) to create content for this page.
...
![Example of a workspace global page](https://dac-static.atlassian.com/platform/forge/images/bitbucket-workspace-global-page.png?_v=1.5800.2158)
