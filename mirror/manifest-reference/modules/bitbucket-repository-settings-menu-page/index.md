# Bitbucket repository settings menu page

The `bitbucket:repoSettingsMenuPage` module adds an item in the `FORGE APPS` section of the left navigation of Bitbucket repository settings menu. When you click the menu item, the content will render on a new Bitbucket page. You can use the [UI Kit](/platform/forge/ui-kit/) or [Custom UI](/platform/forge/custom-ui/) to create content for this page.
...
![Example of a repository settings menu page](https://dac-static.atlassian.com/platform/forge/images/bitbucket-repo-settings-menu.png?_v=1.5800.1824)
...
| `repository.uuid` | `string` | The repository [UUID](https://developer.atlassian.com/cloud/bitbucket/rest/intro#universally-unique-identifier) which will be wrapped in `{}`. |
