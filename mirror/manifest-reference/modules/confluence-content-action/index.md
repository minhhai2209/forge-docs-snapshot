...
![Example of a Content action button](https://dac-static.atlassian.com/platform/forge/snippets/images/content-action-location.png?_v=1.5800.2266)

![Example of a Content action with the above sample code](https://dac-static.atlassian.com/platform/forge/snippets/images/content-action-demo.png?_v=1.5800.2266)
...
When you register a dynamic `confluence:contentAction` module, the `data` object uses the same properties as a static `confluence:contentAction` module in the manifest.
