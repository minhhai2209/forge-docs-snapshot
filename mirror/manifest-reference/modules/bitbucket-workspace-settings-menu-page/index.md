# Bitbucket workspace settings menu page

The `bitbucket:workspaceSettingsMenuPage` module adds an item in the `FORGE APPS` section of the left navigation of Bitbucket workspace settings menu.
...
![Example of a workspace settings menu page](https://dac-static.atlassian.com/platform/forge/images/bitbucket-workspace-settings-menu.png?_v=1.5800.1771)
