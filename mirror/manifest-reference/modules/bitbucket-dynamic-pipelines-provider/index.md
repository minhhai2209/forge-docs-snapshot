...
![Dynamic Pipeline execution hierarchy](https://dac-static.atlassian.com/platform/forge/images/bitbucket-dynamic-pipelines-provider-execution-hierarchy.png?_v=1.5800.2090)
...
![The list of pipeline definitions in the Run pipeline dialog](https://dac-static.atlassian.com/platform/forge/images/bitbucket-dynamic-pipelines-provider-run-pipeline-dialog.png?_v=1.5800.2090)
...
![The custom error message returned by the Dynamic Pipelines provider](https://dac-static.atlassian.com/platform/forge/images/bitbucket-dynamic-pipelines-provider-error-message.png?_v=1.5800.2090)
