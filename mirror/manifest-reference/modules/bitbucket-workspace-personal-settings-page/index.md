# Bitbucket workspace personal settings page

The `bitbucket:workspacePersonalSettingsPage` module adds an item to the Apps section in the personal settings dropdown menu.
The item will be visible in the dropdown menu when viewing pages within a workspace context.
When you select the item, the content will render in a new page.
You can use [UI Kit](/platform/forge/ui-kit/) or [Custom UI](/platform/forge/custom-ui/) to create content for this page.

The page URL is constructed in the form of: `/{workspaceSlug}/workspace/personal-settings/forge/{forgeAppId}/{forgeEnvironmentKey}/{forgeAppModuleKey}`

![Example of a workspace personal settings page](https://dac-static.atlassian.com/platform/forge/images/bitbucket-workspace-personal-settings-page.png?_v=1.5800.1869)
...
| `title` | `string` or `i18n object` | Yes | The title of the page, which is displayed as an item in the personal settings dropdown menu.  The `i18n object` allows for translation. See [i18n object](#i18n-object). |
...
The snippet below defines a workspace personal settings page using UI Kit. This adds "Hello World UI Kit" to the Apps section in the Bitbucket personal settings dropdown menu.
...
modules:
  bitbucket:workspacePersonalSettingsPage:
    - key: hello-world-workspace-personal-settings-page
      resource: main
      resolver:
        function: resolver
      render: native
...
The snippet below defines a workspace personal settings page using Custom UI.
