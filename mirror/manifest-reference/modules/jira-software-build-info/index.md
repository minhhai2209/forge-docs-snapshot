...
modules:
  devops:buildInfoProvider:
    - key: my-build-info-provider
      name:
        value: My Build Info Provider
      homeUrl: https://www.my-build-info.com
      logoUrl: https://www.my-build-info.com/logo.svg
      documentationUrl: https://www.my-build-info.com/help
```
