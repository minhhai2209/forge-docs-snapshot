...
| `title` | `string` or `i18n object` | Yes | The title of the space page app, displayed as a link title.  The `i18n object` allows for translation. See [i18n object](#i18n-object). |
...
| `route` | `string` | Yes | A string of text that makes the URL of the browser more readable. Inside an app, each space page module must have a distinct `route`.  *Regex:* `^[0-9a-z-]+$` |
