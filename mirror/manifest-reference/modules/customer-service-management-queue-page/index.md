...
| `title` | `string` or `i18n object` | Yes | The title of the page, which is displayed at the top of the page. The title also appears as an item under **Queues** in the left navigation of a Customer Service Management space.  The `i18n object` allows for translation. See [i18n object](#i18n-object). |
