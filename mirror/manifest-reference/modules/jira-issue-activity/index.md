...
![Example of an Issue activity](https://dac-static.atlassian.com/platform/forge/snippets/images/issue-activity-module-demo.gif?_v=1.5800.1897)
...
| `title` | `string` or `i18n object` | Yes | The title of the issue activity, which is displayed as a tab item.  The `i18n object` allows for translation. See [i18n object](#i18n-object). |
...
#### Update a dynamic issue activity module
