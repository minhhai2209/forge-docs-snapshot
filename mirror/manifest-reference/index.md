...
| --- | --- | --- | --- |
| `name` | Yes | `string` | Lets you specify the Forge runtime environment version on which to deploy your app. This field supports the following values: * `nodejs22.x`: (recommended) specifies the Node.js 22 runtime version. This version runs on   a standard [Node.js 22](https://nodejs.org/en/blog/release/v22.11.0) environment.   See [Runtime](/platform/forge/runtime-reference/) for more information about the   this runtime version. * `nodejs20.x`: specifies the Node.js 20 runtime version. This version runs on   a standard [Node.js 20](https://nodejs.org/en/blog/release/v20.16.0) environment.   See [Runtime](/platform/forge/runtime-reference/) for more information about the   this runtime version. |
