...
| [Atlassian icon (Preview)](/platform/forge/ui-kit/components/atlassian-icon/) | An icon that represents an Atlassian-specific content type. |
| [Atlassian tile (Preview)](/platform/forge/ui-kit/components/atlassian-tile/) | A tile that contains an icon displaying Atlassian-specific content. |
...
| [Comment](/platform/forge/ui-kit/components/comment/) | A comment displays discussions and user feedback. |
| [Comment editor (Preview)](/platform/forge/ui-kit/components/comment-editor/) | A comment editor provides a contained comment editor UI with a simple toolbar. |
...
| [Tile (Preview)](/platform/forge/ui-kit/components/tile/) | A rounded square that displays assets and represents nouns. |
...
| [Frame](/platform/forge/ui-kit/components/frame/) | A container for rendering static frontend applications, such as HTML, CSS, and JavaScript, ensuring seamless integration with the UI Kit. |
...
| Components | Description |
| --- | --- |
| [Bleed (Preview)](/platform/forge/ui-kit/components/bleed/) | Bleed allows child elements to visually extend beyond the bounds of their parent container. This is useful for creating visual effects where a child needs to break out of its parent's padding or spacing. |
...
| Components | Description |
| --- | --- |
| [Breadcrumbs (Preview)](/platform/forge/ui-kit/components/breadcrumbs/) | Breadcrumbs are a navigation system used to show a user's location in a site or app. |
| [Empty state](/platform/forge/ui-kit/components/empty-state/) | An empty state appears when there is no data to display and describes what the user can do next. |
| [Pagination (Preview)](/platform/forge/ui-kit/components/pagination/) | Pagination allows you to divide large amounts of content into chunks across multiple pages. |
| [Router (Preview)](/platform/forge/ui-kit/components/router/) | Provides client-side routing for full page apps, including the Router and Route components for managing navigation state and rendering matched routes. |
...
| [Chromeless editor (Preview)](/platform/forge/ui-kit/components/chromeless-editor/) | A simple text editor without a toolbar, ideal for when you want complete control over the editor UI and for users to interact via markdown shortcuts. |
