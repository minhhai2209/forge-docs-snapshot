...
2. In the issue panel of that issue, select the Apps button and select your app from the list.
   ...
   ![Image of Cross-Context App in Jira](https://dac-static.atlassian.com/platform/forge/images/forge-getting-started-xpa-jira-initial-state.png?_v=1.5800.2073)
...
[![A button to go back a page](https://dac-static.atlassian.com/platform/forge/images/button-go-back.svg?_v=1.5800.2073)](/platform/forge/call-a-confluence-api-in-a-confluence-jira-app/)
[![A button to go to the next tutorial](https://dac-static.atlassian.com/platform/forge/images/button-next-tutorial.svg?_v=1.5800.2073)](/platform/forge/change-the-frontend-with-ui-kit-for-a-confluence-jira-app/)
