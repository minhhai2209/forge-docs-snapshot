...
![Forge Container services lifecycle overview](https://dac-static.atlassian.com/platform/forge/images/containers-lifecycle-overview.png?_v=1.5800.2255)
...
2. The container has a grace period of 5 minutes for cleanup and exit.
3. If the process is still running after 5 minutes, a `SIGKILL` signal is sent to forcibly terminate the process.
...
The 5-minute grace period is a maximum - if your application finishes shutting down sooner, it will exit immediately.
