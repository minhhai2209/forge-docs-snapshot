...
This Forge Rovo Agent app uses [Rovo Agent](/platform/forge/manifest-reference/modules/rovo-agent/) and
[Action](/platform/forge/manifest-reference/modules/rovo-action/) modules to curate and automate team-bonding experiences.
By leveraging custom [Actions](/platform/forge/manifest-reference/modules/rovo-action/), the agent can transform vague ideas
into engaging and structured Confluence pages.

### Details

## Jira Issue Analyst

This Forge Rovo Agent app uses [Rovo Agent](/platform/forge/manifest-reference/modules/rovo-agent/) and [Action](/platform/forge/manifest-reference/modules/rovo-action/) modules to help support and engineering teams analyze issue queues effectively.
...
This Forge Rovo Agent app uses Confluence pages through the [Rovo Agent](/platform/forge/manifest-reference/modules/rovo-agent/) and [Action](/platform/forge/manifest-reference/modules/rovo-action/) modules.
