...
![Custom metrics registration](https://dac-static.atlassian.com/platform/forge/images/custom-metrics-registration.png?_v=1.5800.2266)
...
![View custom metrics](https://dac-static.atlassian.com/platform/forge/images/view-custom-metrics.png?_v=1.5800.2266)
...
![Custom metrics unregistration](https://dac-static.atlassian.com/platform/forge/images/custom-metrics-unregistration.png?_v=1.5800.2266)
...
7. In the **Details** tab, under **Custom metrics access**, enable the setting.
   ...
   ![The admin hub app details page, showing details, and the section to enable custom metrics](https://dac-static.atlassian.com/platform/forge/images/admin-hub-access-custom-metrics-section.png?_v=1.5800.2266)
