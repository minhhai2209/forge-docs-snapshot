...
![Sequence diagram to explain the approach.](https://dac-static.atlassian.com/platform/forge/images/jsm-assets-import/queues-diagram.png?_v=1.5800.2113)
...
Since this app uses [Forge Storage API](/platform/forge/storage-reference/), we will need to update the manifest to include the following scope:
...
![Assets import app backed by Forge Async Events runs when an user click 'Start Import' in Import tab.](https://dac-static.atlassian.com/platform/forge/images/jsm-assets-import/import-app-running.gif?_v=1.5800.2113)
