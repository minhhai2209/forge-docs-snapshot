...
2. In the Chat side panel, click the Agent selector and go to Browse Agents.
   ![example of browsing rovo agent from the list](https://dac-static.atlassian.com/platform/forge/images/rovo/rovo-agent-browse.png?_v=1.5800.2172)
3. Find the `Hello world` Agent and click **Enable**.
4. Now use the Agent selector to select the **Hello world agent**.
   ![example of Agent hello world app](https://dac-static.atlassian.com/platform/forge/images/rovo/rovo-agent-app.png?_v=1.5800.2172)
5. Chat with the Agent and invoke your action. Ask the Agent to log a message for you
   ...
   ![example of Rovo agent chat window](https://dac-static.atlassian.com/platform/forge/images/rovo/rovo-agent-chat.png?_v=1.5800.2172)
6. Navigate to the app's top-level directory to check the logs by running:

You should see a Forge log with your message:

![example of Rovo agent creating a log](https://dac-static.atlassian.com/platform/forge/images/rovo/rovo-agent-log.png?_v=1.5800.2172)
...
3. Test your Agent again. Notice the change in tone:
   ![example of Agent chat after changing the prompt](https://dac-static.atlassian.com/platform/forge/images/rovo/rovo-agent-prompt.png?_v=1.5800.2172)
...
5. Test your Agent again:
   ...
   ![example of Agent chat after changing the action](https://dac-static.atlassian.com/platform/forge/images/rovo/rovo-agent-action.png?_v=1.5800.2172)
6. Check the Forge logs to verify that the action was successfully executed:

   You should see Forge logs with your messages:

   ![example of Agent chat after changing the action](https://dac-static.atlassian.com/platform/forge/images/rovo/rovo-agent-log-confluence.png?_v=1.5800.2172)
